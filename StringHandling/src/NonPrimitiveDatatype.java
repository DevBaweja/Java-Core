public class NonPrimitiveDatatype {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * Such as structure in c/c++ which are non-primitive datetype
		 * java have String,Array,Enum
		 * Classe,Object,Interface as non-primitive datatype
		 */
		
		//  Here, string act as String- Wrapper Class
